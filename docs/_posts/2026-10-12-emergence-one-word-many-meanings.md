...
It is tempting to read this as somebody's failure. I don't. To me it reads as a fact about words and the contexts they get their meaning in. Each discipline built its sense of "emergence" inside its own language — its own instruments, cases, and standards — and within that context each sense is exact and earns its keep. What has not happened is a further step: the senses converging across contexts into one shared meaning, the way "energy" eventually did across mechanics, chemistry and biology — the mid-nineteenth-century convergence of heat, work and chemical energy under conservation. That step is neither automatic nor guaranteed; it is its own achievement.

Emergence is the word communities use for something new arising from many parts — and as a meaning, across its many communities, that has not happened to the word itself.
