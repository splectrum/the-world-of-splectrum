...
layout: default
lastmod: 2026-09-10
title: "Emergence — Relation with Mechanism"
description: "The types of emergence cross-tabulated by checkable properties of their definitions: the relation to mechanism, the vocabulary or formalism each is stated in, how each is given, and which terms each takes as primitive."
---

[Home](/) > [Positioning](/positioning/) > [Subjects](/positioning/subjects/) > [Emergence](/positioning/subjects/e/emergence/) > Relation with mechanism

# Emergence — Relation with Mechanism

[The types of emergence](/positioning/subjects/e/emergence/the-types/) can be sorted by properties that are checkable against each definition's own text: whether the definition states a mechanism for the emergent, classifies without one, or holds the emergent's underivability as ultimate; the language context the definition is stated in; the manner in which it is given — formally within a formalism, operationally as a testable criterion, criterially as conditions in a discipline's vocabulary, or informally as a cluster description; and which of its terms it takes as primitive. This page tabulates those properties and shows how they align.
...
| Terms taken as primitive | Few — the terms are defined within the formalism |

## Definitions that classify without a mechanism
...
| Terms taken as primitive | "Level," "power," "novel," "in principle" |

## Definitions on which the underivability is ultimate
...
| How given | Criterial |
| Terms taken as primitive | "In principle," "fundamental," "brute" |

The tables give representative entries; [the types page](/positioning/subjects/e/emergence/the-types/) carries the full catalogue.

The alignment is close but not exact, and the exceptions are among the catalogue's most-used entries: the aggregativity conditions are operational — four testable conditions — from within the second group's vocabulary, and simulation-sense weak emergence straddles the first two groups. The first group's language contexts include philosophy: fusion, contextual, and asymptotic emergence are philosophers' definitions stated inside the sciences' formalisms — the groups sort by the vocabulary or formalism a definition is stated in, not by the discipline of its author. And the field's most-used sorting, weak against strong, runs largely *within* the second and third groups — a division among the classifying and ultimate-underivability definitions — with Bar-Yam's multiscale account, explicitly a theory of strong emergence, the named exception in the first group, and Fromm's ladder ending in strong.

---

See also: [Emergence](/positioning/subjects/e/emergence/) (the subject landing) · [The types of emergence](/positioning/subjects/e/emergence/the-types/) · [The overviews](/positioning/subjects/e/emergence/the-overviews/)
